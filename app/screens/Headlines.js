import { STRINGS, CATEGORIES, CATEGORY_ICONS, REFS, KEYS, ALIGNMENTS, FONTS, COLORS, MARGINS } from '../assets/constants.js';
          ...
          renderItem={({ item }) =>
            <TouchableOpacity onPress={() => { this.setCategory(item.key); this.refs.drawer.close() }}>
              <View style={styles.sideMenuItem}>
                <Ionicons name={CATEGORY_ICONS[item.key]} style={this.setTextStyle(item.key)} size={16} />
